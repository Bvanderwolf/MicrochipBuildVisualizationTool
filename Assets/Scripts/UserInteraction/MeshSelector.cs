...
namespace BWolf.UserInteraction
{
    ...
    public sealed class MeshSelector : MonoBehaviour
    {
        ...
        private void OnClick(Vector3 mousePosition)
        {
            ...
            IUserInteractable selectableMesh = clickedGameObject.GetComponent<IUserInteractable>();
        ...
        /// to invoke implementations of the IUserInteractable interface 
        /// </summary>
        ...
        private void OnSelectionChanged(Collider[] newSelection)
        {
            ...
            for (int i = 0; i < newlySelectedGameObjects.Length; i++)
            {
                ...
                newlySelectedGameObject.GetComponent<IUserInteractable>()?.OnSelect();
